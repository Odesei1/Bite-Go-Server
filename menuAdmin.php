...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <div class="dropdown">
        <a href="adminDashboard.php"><button>Admin Dashboard</button></a>
      </div>
      <div class="dropdown">
        <a href="menuAdmin.php"><button>Menu</button></a>
      </div>
      <div class="dropdown"><a href="inventoryAdmin.php"><button>Inventory</button></div>
      <div class="dropdown">
